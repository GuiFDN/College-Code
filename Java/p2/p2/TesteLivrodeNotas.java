...
public class TesteLivrodeNotas {
    public static void main(String[] args) {
        ...
        String primeiroCurso = JOptionPane.showInputDialog
        ("Prof, qual o nome do primeiro curso?");
        String segundoCurso = JOptionPane.showInputDialog
        ("Prof, qual o nome do segundo curso?");
